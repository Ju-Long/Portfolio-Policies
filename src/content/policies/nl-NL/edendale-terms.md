...
officiële Edendale-apps en de Edendale-website (samen de "**Dienst**"). De
Dienst wordt geleverd door **BaBaSaMa** ("**wij**", "**ons**" of "**onze**").

Door de Dienst te downloaden, te openen of te gebruiken, ga je akkoord met deze
Voorwaarden en het [privacybeleid](../privacy/). Ga je niet akkoord, gebruik de
Dienst dan niet.

Ook de voorwaarden van de platformwinkels gelden. Voor een via Apple verkregen
Edendale-binary geldt uitsluitend Apple's
[standaard licentieovereenkomst voor eindgebruikers](https://www.apple.com/legal/internet-services/itunes/dev/stdeula/)
voor de licentie om die Apple-binary te installeren en te gebruiken. Deze
Voorwaarden gelden voor de website, integraties, aanvaardbaar gebruik en de
overige kenmerken van de Dienst, voor zover ze niet in strijd zijn met de
overeenkomst van Apple. Rechten die niet rechtsgeldig kunnen worden uitgesloten,
blijven van toepassing.

## 2. Wat Edendale biedt
...
videospeler en biedt geen account-, bibliotheek- of afspeelfunctie.

## 3. Bevoegdheid

Je moet juridisch bevoegd zijn deze Voorwaarden aan te gaan. Ben je jonger dan
de leeftijd waarop je in jouw land een overeenkomst mag sluiten, dan moet een
ouder of wettelijk vertegenwoordiger deze Voorwaarden voor je beoordelen en
aanvaarden.

## 4. Licentie voor gebruik van de officiële Dienst

Behalve voor een Apple-binary die onder de overeenkomst van Apple valt, en met
inachtneming van deze Voorwaarden, verlenen we je een persoonlijke, beperkte,
niet-exclusieve, niet-overdraagbare en herroepbare licentie om officiële
Edendale-distributies te gebruiken voor rechtmatige persoonlijke doeleinden op
apparaten die je bezit of beheert, met inachtneming van de gebruiksregels van
het betreffende platform.

De broncode van Edendale is beschikbaar onder de
[Mozilla Public License 2.0](https://github.com/Ju-Long/Edendale/blob/main/LICENSE).
Die licentie geldt voor de gedekte broncode en wijzigingen daarop; deze
Voorwaarden vervangen of beperken de daarin verleende rechten niet. De MPL 2.0
verleent geen rechten op de naam, merken of huisstijl van Edendale. Componenten
van derden blijven onderworpen aan hun eigen vermeldingen en licenties.
...
Op ondersteunde platforms kan het koppelen van een TMDB-account ertoe leiden dat
favorieten, kijklijstitems en beoordelingen met TMDB worden gesynchroniseerd. Je
...
de TMDB-API, maar wordt niet onderschreven of gecertificeerd door TMDB.

TMDB-inhoud kan onjuist, onvolledig, vertraagd, gewijzigd of verwijderd zijn. Ze
behoort toe aan de respectieve eigenaren en wordt geleverd onder de
[gebruiksvoorwaarden](https://www.themoviedb.org/terms-of-use), de
[API-voorwaarden](https://www.themoviedb.org/api-terms-of-use) en het overige
toepasselijke beleid van TMDB.

Koppel je een TMDB-account, dan machtig je Edendale om de door jou gevraagde
accountacties uit te voeren. Je kunt het account via Edendale loskoppelen en
informatie rechtstreeks via TMDB beheren of verwijderen. Wij zijn niet
...
beoordelen de inhoud niet voordat je het downloadt. Je bent zelf verantwoordelijk
voor naleving van de voorwaarden van de ondertiteldienst en van het recht dat op
jou van toepassing is. De dienst kan een API-sleutel vereisen die je zelf
...
informatie verzamelen of verwerken onder de voorwaarden van Google en YouTube.

Wij hebben geen invloed op de beschikbaarheid, juistheid, leeftijdsgeschiktheid,
...
- de site of de hostinginfrastructuur onderzoeken, aanvallen, verstoren of
  proberen er zonder toestemming toegang toe te krijgen;
...
gegeven. Er wordt geen merklicentie verleend, behalve voor zover nodig om
...
dat de Dienst of een aanbieder van derden altijd beschikbaar, compatibel, veilig
of foutloos is.

Updates kunnen nodig zijn om veiligheids- of compatibiliteitsredenen. Je bent
...
impliciet of wettelijk. Dit omvat impliciete garanties van verkoopbaarheid,
bevredigende kwaliteit, geschiktheid voor een bepaald doel, eigendom,
niet-inbreuk, juistheid, beschikbaarheid en ongestoord genot.
...
beperkt, onze totale aansprakelijkheid voor vorderingen met betrekking tot de
Dienst niet hoger is dan het hoogste van:

1. het bedrag dat je in de twaalf maanden vóór de gebeurtenis die tot de
   vordering leidde rechtstreeks aan ons voor Edendale hebt betaald; of
2. **SGD 50**.

Deze paragraaf beperkt niet de aansprakelijkheid voor fraude, opzet, overlijden
of persoonlijk letsel door nalatigheid, of enige aansprakelijkheid die niet
rechtsgeldig kan worden beperkt. Sommige rechtsgebieden staan bepaalde
...
gebruik, onderhoud en ondersteuning, garanties, productclaims, claims over
intellectuele eigendom en Apple als derde-begunstigde. Zijn deze Voorwaarden in
strijd met Apple's standaard-EULA over die binarylicentie, dan gaat de
overeenkomst van Apple voor.
...
gelden. Bepalingen die naar hun aard behoren voort te duren — waaronder
eigendom, garantie-uitsluitingen, aansprakelijkheidsbeperkingen, toepasselijk
...
toepassing van conflictregels. De rechtbanken van Singapore zijn bevoegd, tenzij
dwingend consumentenrecht van jouw land je het recht geeft een ander recht, forum
of geschilprocedure te kiezen.

Voordat een formele procedure wordt gestart, komen jij en BaBaSaMa overeen een
redelijke inspanning te leveren om de kwestie te goeder trouw per e-mail op te
...
waar passend aanvullend. Ga je niet akkoord met de herziene Voorwaarden, dan moet
