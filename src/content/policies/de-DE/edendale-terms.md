...
offiziellen Edendale-Anwendungen und der Edendale-Website (zusammen der
„**Dienst**“). Der Dienst wird von **BaBaSaMa** („**wir**“, „**uns**“ oder
„**unser**“) bereitgestellt.

Mit dem Herunterladen, dem Zugriff auf oder der Nutzung des Dienstes stimmen Sie
diesen Bedingungen und der [Datenschutzerklärung](../privacy/) zu. Wenn Sie
nicht einverstanden sind, nutzen Sie den Dienst nicht.

Zusätzlich gelten die Bedingungen der jeweiligen Plattform-Marktplätze. Für eine
über Apple bezogene Edendale-Binärdatei regelt Apples
[Standard-Lizenzvertrag für Programme (Standard EULA)](https://www.apple.com/legal/internet-services/itunes/dev/stdeula/)
ausschließlich die Lizenz zur Installation und Nutzung dieser Apple-Binärdatei.
Diese Bedingungen regeln die Website, Integrationen, die zulässige Nutzung und
weitere Merkmale des Dienstes, soweit sie nicht im Widerspruch zu Apples
Vereinbarung stehen. Rechte, die nicht wirksam ausgeschlossen werden können,
bleiben bestehen.

## 2. Was Edendale bietet
...
1. bestimmte persönliche Datensätze über Ihr eigenes Plattformkonto oder ein
   optionales TMDB-Konto synchronisieren, sofern die Funktion verfügbar ist.
...
geteilter Edendale-Link in einer installierten App geöffnet werden kann. Sie ist
kein Videoplayer und bietet keine Konto-, Mediathek- oder Wiedergabefunktion.

## 3. Berechtigung

Sie müssen rechtlich in der Lage sein, diese Bedingungen einzugehen. Liegen Sie
unter dem Alter, ab dem Sie in Ihrem Land einen Vertrag schließen dürfen, muss
ein Elternteil oder gesetzlicher Vormund diese Bedingungen für Sie prüfen und
annehmen.

## 4. Lizenz zur Nutzung des offiziellen Dienstes

Mit Ausnahme einer Apple-Binärdatei, die Apples Vereinbarung unterliegt, und
vorbehaltlich dieser Bedingungen gewähren wir Ihnen eine persönliche,
beschränkte, nicht ausschließliche, nicht übertragbare und widerrufliche Lizenz
zur Nutzung offizieller Edendale-Distributionen für rechtmäßige persönliche
Zwecke auf Geräten, die Sie besitzen oder kontrollieren, vorbehaltlich der
Nutzungsregeln der jeweiligen Plattform.

Der Quellcode von Edendale ist unter der
[Mozilla Public License 2.0](https://github.com/Ju-Long/Edendale/blob/main/LICENSE)
verfügbar. Diese Lizenz regelt den erfassten Quellcode und dessen Änderungen;
die vorliegenden Bedingungen ersetzen oder beschränken die dadurch gewährten
Rechte nicht. Die MPL 2.0 gewährt keine Rechte an Namen, Marken oder Branding
von Edendale. Komponenten Dritter unterliegen weiterhin ihren eigenen Hinweisen
und Lizenzen.
...
Edendale nicht veröffentlicht.

Auf unterstützten Plattformen kann das Verbinden eines TMDB-Kontos dazu führen,
dass Favoriten, Merklisteneinträge und Bewertungen mit TMDB synchronisiert
...
TMDB-API, wird jedoch von TMDB weder unterstützt noch zertifiziert.

TMDB-Inhalte können unrichtig, unvollständig, verzögert, geändert oder entfernt
sein. Sie gehören ihren jeweiligen Eigentümern und werden vorbehaltlich der
[Nutzungsbedingungen](https://www.themoviedb.org/terms-of-use), der
[API-Bedingungen](https://www.themoviedb.org/api-terms-of-use) und weiterer
geltender Richtlinien von TMDB bereitgestellt.

Wenn Sie ein TMDB-Konto verbinden, ermächtigen Sie Edendale, die von Ihnen
angeforderten Kontoaktionen auszuführen. Sie können das Konto über Edendale
trennen und Informationen unmittelbar über TMDB verwalten oder löschen. Für
...
prüfen ihren Inhalt vor dem Herunterladen nicht. Sie sind dafür verantwortlich,
die Bedingungen des Untertiteldienstes und das für Sie geltende Recht
einzuhalten. Der Dienst kann einen API-Schlüssel erfordern, den Sie selbst
...
sowie Informationen gemäß den Bedingungen von Google und YouTube erheben oder
verarbeiten.

Wir kontrollieren weder Verfügbarkeit, Richtigkeit, Altersfreigabe, Werbung,
...
- die Website oder ihre Hosting-Infrastruktur ausspähen, angreifen, stören oder
...
keine Markenlizenz gewährt, außer soweit dies erforderlich ist, um
...
garantieren nicht, dass der Dienst oder ein Anbieter eines Dritten stets
verfügbar, kompatibel, sicher oder fehlerfrei ist.

Updates können aus Sicherheits- oder Kompatibilitätsgründen erforderlich sein.
...
jeglicher Art, seien sie ausdrücklich, konkludent oder gesetzlich. Dies umfasst
konkludente Gewährleistungen der Marktgängigkeit, zufriedenstellenden Qualität,
Eignung für einen bestimmten Zweck, des Rechtsbestands, der Nichtverletzung von
Rechten, der Richtigkeit, Verfügbarkeit und ungestörten Nutzung.
...
übersteigt unsere Gesamthaftung für Ansprüche im Zusammenhang mit dem Dienst
nicht den höheren der folgenden Beträge:
...
Haftung, die rechtlich nicht beschränkt werden kann. In manchen
...
Nutzung, Wartung und Support, Gewährleistungen, Produktansprüchen, Ansprüchen
wegen Verletzung geistigen Eigentums sowie zu Apple als begünstigtem Dritten.
Widersprechen diese Bedingungen Apples Standard EULA hinsichtlich dieser
Binärlizenz, geht Apples Vereinbarung vor.
...
Apples Standard EULA. Bestimmungen, die ihrer Natur nach fortgelten sollen –
darunter Eigentum, Haftungsausschlüsse, Haftungsbeschränkungen, anwendbares
...
Kollisionsrechts. Zuständig sind die Gerichte in Singapur, es sei denn,
zwingendes Verbraucherschutzrecht Ihres Landes gibt Ihnen das Recht, ein
anderes Recht, einen anderen Gerichtsstand oder ein anderes Streitverfahren zu
wählen.

Vor Einleitung eines förmlichen Verfahrens verpflichten Sie und BaBaSaMa sich,
in angemessener und gutgläubiger Weise zu versuchen, die Angelegenheit per
...
aktualisiert** an und weisen, soweit angemessen, zusätzlich darauf hin. Wenn Sie
den geänderten Bedingungen nicht zustimmen, müssen Sie die Nutzung des Dienstes
