...
applicazioni Edendale ufficiali e del sito web di Edendale (complessivamente, il
«**Servizio**»). Il Servizio è fornito da **BaBaSaMa** («**noi**» o
«**nostro**»).

Scaricando, accedendo o utilizzando il Servizio, accetti le presenti Condizioni
e l'[informativa sulla privacy](../privacy/). Se non le accetti, non utilizzare
il Servizio.

Si applicano anche le condizioni degli store delle piattaforme. Per un binario
Edendale ottenuto tramite Apple, il
[Contratto di licenza con l'utente finale standard di Apple](https://www.apple.com/legal/internet-services/itunes/dev/stdeula/)
disciplina in via esclusiva la licenza di installazione e uso di quel binario
Apple. Le presenti Condizioni disciplinano il sito web, le integrazioni, l'uso
consentito e le altre caratteristiche del Servizio, nella misura in cui non
contrastino con l'accordo di Apple. I diritti che non possono essere
legittimamente esclusi restano applicabili.

## 2. Che cosa offre Edendale
...
1. sincronizzare determinate registrazioni personali tramite il tuo account di
   piattaforma o un account TMDB facoltativo, ove la funzione sia disponibile.
...
Edendale condiviso possa aprirsi in un'app installata. Non è un lettore video e
non offre funzioni di account, videoteca o riproduzione.

## 3. Capacità

Devi avere la capacità giuridica di accettare le presenti Condizioni. Se non hai
raggiunto l'età in cui puoi concludere un contratto nel tuo Paese, un genitore o
tutore legale deve esaminarle e accettarle per te.

## 4. Licenza d'uso del Servizio ufficiale

Fatta eccezione per un binario Apple disciplinato dall'accordo di Apple, e nel
rispetto delle presenti Condizioni, ti concediamo una licenza personale,
limitata, non esclusiva, non trasferibile e revocabile per l'uso delle
distribuzioni ufficiali di Edendale a fini personali leciti su dispositivi che
possiedi o controlli, nel rispetto delle regole d'uso della piattaforma
applicabile.

Il codice sorgente di Edendale è disponibile con licenza
[Mozilla Public License 2.0](https://github.com/Ju-Long/Edendale/blob/main/LICENSE).
Tale licenza disciplina il codice sorgente coperto e le sue modifiche; le
presenti Condizioni non sostituiscono né limitano i diritti che essa concede. La
MPL 2.0 non concede diritti sul nome, sui marchi o sull'identità visiva di
Edendale. I componenti di terzi restano soggetti alle proprie note e licenze.
...
Sulle piattaforme supportate, il collegamento di un account TMDB può comportare
la sincronizzazione di preferiti, voci della lista di visione e valutazioni con
...
non è approvato né certificato da TMDB.

I contenuti TMDB possono essere inesatti, incompleti, non aggiornati, modificati
o rimossi. Appartengono ai rispettivi titolari e sono forniti nel rispetto delle
[condizioni d'uso](https://www.themoviedb.org/terms-of-use), delle
[condizioni API](https://www.themoviedb.org/api-terms-of-use) e delle altre
politiche applicabili di TMDB.

Se colleghi un account TMDB, autorizzi Edendale a compiere le azioni sull'account
che richiedi. Puoi scollegare l'account da Edendale e gestire o cancellare le
...
né ne esaminiamo il contenuto prima del download. Sei responsabile del rispetto
delle condizioni del servizio di sottotitoli e della legge a te applicabile. Il
...
pubblicità e raccogliere o trattare informazioni secondo le condizioni di Google
e di YouTube.

Non controlliamo disponibilità, esattezza, idoneità per fasce d'età, pubblicità,
...
- sondare, attaccare o disturbare il sito o la sua infrastruttura di hosting, né
...
alcuna licenza sui marchi, se non nella misura necessaria per riferirsi
...
che il Servizio o un fornitore terzo siano sempre disponibili, compatibili,
sicuri o privi di errori.

Gli aggiornamenti possono essere necessari per motivi di sicurezza o
...
tipo, espresse, implicite o di legge. Ciò include le garanzie implicite di
commerciabilità, qualità soddisfacente, idoneità a uno scopo particolare,
titolarità, non violazione di diritti, esattezza, disponibilità e godimento
pacifico.
...
limitata, la nostra responsabilità complessiva per pretese relative al Servizio
non supererà il maggiore tra:
...
consentito, manutenzione e assistenza, garanzie, reclami sul prodotto, pretese in
materia di proprietà intellettuale e Apple come terzo beneficiario. In caso di
contrasto tra le presenti Condizioni e l'EULA standard di Apple riguardo a tale
licenza del binario, prevale l'accordo di Apple.
...
Apple. Le disposizioni che per loro natura devono sopravvivere — tra cui
titolarità, esclusioni di garanzia, limiti di responsabilità, legge applicabile e
...
senza riguardo alle norme sui conflitti di legge. Saranno competenti i tribunali
di Singapore, salvo quando la normativa imperativa a tutela dei consumatori del
tuo Paese ti riconosca il diritto di ricorrere a un'altra legge, a un altro foro
o a un altro procedimento di risoluzione.

Prima di avviare un procedimento formale, tu e BaBaSaMa vi impegnate a compiere
...
aggiornamento** e forniremo, ove opportuno, un avviso ulteriore. Se non accetti
