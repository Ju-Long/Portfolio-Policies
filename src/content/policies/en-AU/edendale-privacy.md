...
TMDB account identifier so it can synchronise supported favourites, watchlist
...
Apple platforms, a credential may synchronise through iCloud Keychain when you
...
progress, favourites, watchlist entries, and ratings are also stored locally
