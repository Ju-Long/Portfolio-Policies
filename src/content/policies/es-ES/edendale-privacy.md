...
Te permite reproducir los medios que elijas, crear una videoteca privada,
...
- BaBaSaMa no opera ningún servidor, base de datos ni proxy para Edendale. No
  ...
  videoteca, tu reproducción o tus cuentas.
...
### 4.1 Medios locales e información de la videoteca
...
El índice de la videoteca local, las rutas de archivo y los marcadores con
...
Windows guarda el índice de la videoteca local en el almacenamiento local de la
...
reparto, valoraciones, referencias de tráileres y enriquecimiento de la videoteca
...
visto, qué contiene tu videoteca ni quién eres.

## 10. Cómo se utiliza la información

| Finalidad | Información | Base jurídica habitual cuando se exige |
|---|---|---|
| Indexar y reproducir los medios que selecciones | Medios locales e información de la videoteca | Ejecución del Servicio que solicitas |
...
| Conectar con una cuenta opcional de TMDB o un recurso de red | Token de cuenta o credenciales del recurso | Tu solicitud o consentimiento |
...
datos de vídeo y los registros personales fuera de cualquier almacenamiento
