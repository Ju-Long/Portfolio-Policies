...
applications and the Edendale website (together, the "**Service**"). The
Service is provided by **BaBaSaMa** ("**we**", "**us**", or "**our**").

By downloading, accessing, or using the Service, you agree to these Terms and
the [Privacy Policy](../privacy/). If you do not agree, do not use the Service.

Platform marketplace terms also apply. For an Edendale binary obtained through
Apple, Apple's
[Standard Licensed Application End User License Agreement](https://www.apple.com/legal/internet-services/itunes/dev/stdeula/)
exclusively governs the license to install and use that Apple binary. These
Terms govern the website, integrations, acceptable use, and other Service
features to the extent they do not conflict with Apple's agreement. Rights that
cannot lawfully be excluded continue to apply.

## 2. What Edendale provides
...
1. save watch progress, favorites, watchlist choices, ratings, and
   preferences; and
1. synchronize certain personal records through your own platform account or an
...
can open in an installed app. It is not a video player and provides no account,
library, or playback feature.

## 3. Eligibility

You must be legally able to enter into these Terms. If you are below the age at
which you may enter a contract in your country, a parent or legal guardian must
review and accept these Terms for you.

## 4. License to use the official Service

Except for an Apple binary governed by Apple's agreement, and subject to these
Terms, we grant you a personal, limited, non-exclusive, non-transferable, and
revocable license to use official Edendale distributions for lawful personal
purposes on devices you own or control, subject to the applicable platform's
usage rules.

Edendale's source code is available under the
[Mozilla Public License 2.0](https://github.com/Ju-Long/Edendale/blob/main/LICENSE).
That license governs the covered source code and modifications to it; these
Terms do not replace or restrict the rights it grants. The MPL 2.0 does not
grant rights to Edendale's name, trademarks, or branding. Third-party
components remain subject to their own notices and licences.
...
- access files, accounts, devices, or network shares without authorization;
...
Ratings and watch records are personal organizational features for your own
use. They are not a public review service and are not published by Edendale.

On supported platforms, connecting a TMDB account may cause favorites,
watchlist entries, and ratings to synchronize with TMDB. You are responsible
...
TMDB content may be inaccurate, incomplete, delayed, changed, or removed. It
belongs to its respective owners and is provided subject to TMDB's
[Terms of Use](https://www.themoviedb.org/terms-of-use),
[API Terms](https://www.themoviedb.org/api-terms-of-use), and other applicable
policies.

If you connect a TMDB account, you authorize Edendale to perform the account
actions you request. You may disconnect the account through Edendale and manage
...
its contents before you download it. You are responsible for complying with the
subtitle service's terms and with the law that applies to you. The service may
...
collect or process information under Google's and YouTube's terms.

We do not control a trailer's availability, accuracy, age suitability,
...
- probe, attack, disrupt, or attempt unauthorized access to the site or its
...
owned by BaBaSaMa or licensed to us. No trademark license is granted except as
...
Service or a third-party provider will always be available, compatible, secure,
or error-free.

Updates may be required for security or compatibility. You are responsible for
...
implied, or statutory. This includes implied warranties of merchantability,
satisfactory quality, fitness for a particular purpose, title,
non-infringement, accuracy, availability, and quiet enjoyment.
...
- metadata, ratings, cast, subtitles, or trailers will be accurate or
  available;
- watch progress, ratings, or synchronization will never be lost, duplicated,
...
liability for claims relating to the Service will not exceed the greater of:

1. the amount you paid directly to us for Edendale during the twelve months
   before the event giving rise to the claim; or
2. **SGD 50**.

This section does not limit liability for fraud, willful misconduct, death or
personal injury caused by negligence, or any liability that cannot lawfully be
...
exclusively governs the binary license, including its rules about permitted
use, maintenance and support, warranties, product claims,
intellectual-property claims, and Apple as a third-party beneficiary. If these
Terms conflict with Apple's Standard EULA about that binary license, Apple's
agreement controls.
...
On termination, any non-Apple license granted by these Terms ends. The Apple
binary license remains governed by Apple's Standard EULA. Provisions that by
their nature should survive—including ownership, disclaimers, liability
limits, governing law, and third-party terms—will continue to apply. The MPL
2.0 source-code license remains governed by its own terms.

## 19. Governing law and disputes

Except for the Apple binary license governed by Apple's Standard EULA, these
Terms are governed by the laws of **Singapore**, without regard to
conflict-of-law principles. The courts of Singapore will have jurisdiction,
except where the mandatory consumer-protection law of your country gives you
the right to use another law, forum, or dispute process.

Before starting formal proceedings, you and BaBaSaMa agree to make a reasonable
